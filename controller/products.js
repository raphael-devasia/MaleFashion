...
// /////FOR THE NEW USER WITHOURT ADRESS IDS 
// if(userdetails.address_id.length<1){
...
//         billingHouseNumber === shippingHouseNumber &&
//         billingAddressLine1 === shippingAddressLine1 &&
//         billingAddressLine2 === shippingAddressLine2 &&
//         billingState === shippingState &&
//         billingPostalCode === shippingPostalCode
//     ) {
//         // Create User Address with the same address for Billing and Shipping
...
//         // Create User Address for Billing Address
//         const newUserAddressBilling = new User_address({
//             Is_Billing_default: true,
//             Is_Shipping_default: false,
//             Address_id: newAddress._id,
//         })

//         await newUserAddressBilling.save()

//         // Create User Address for Shipping Address
//         const newUserAddressShipping = new User_address({
//             Is_Billing_default: false,
//             Is_Shipping_default: true,
//             Address_id: newShippingAddress._id,
//         })

//         await newUserAddressShipping.save()
//     }

//     // Find the user and update the address_id
//     const userbill = await collection
//         .findOneAndUpdate(
//             { email: userSession },
//             { $push: { address_id: newUserAddressBilling._id } },
//             { new: true }
//         )
//         .populate("address_id")
//         const usership = await collection
//             .findOneAndUpdate(
//                 { email: userSession },
//                 { $push: { address_id: newUserAddressShipping._id } },
//                 { new: true }
//             )
//             .populate("address_id")
// }
// ///////without adress id ends

//         const shippingAddress = userdetails.address_id.find((e) => {
//             return e.Is_Shipping_default
//         })
//         const billingAddress = userdetails.address_id.find((e) => {
...
// ////CHECKING EXISTING ADRESSESS END
...
//         await User_address.findOneAndUpdate(
//             { Address_id: billingAddressId },
//             { Is_Shipping_default: true ,
//                 Is_Billing_default: true,
//             }
...
//             // if(e.Product_Category_offers){
//             //    const newUpdation = await Order_line.findByIdAndUpdate(
//             //        orderLine._id,
//             //        {
//             //            $addToSet: {
//             //                Product_item_id: e.Product_item_id,
...
// const removeCoupon = await collection.findByIdAndUpdate(userdetails._id,{$set:{coupon:""}},{new:true})
...
//                 const deleteCart = await Shopping_cart.findByIdAndDelete(cartId)
//             } else {
//                 console.log("Product not found.")
//             }
//         }
