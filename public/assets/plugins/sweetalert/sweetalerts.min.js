    ...
    $("#basic-alert").on("click", function () {
        ...
        $(".confirm-text").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Perform AJAX request to soft delete the category
                    $.ajax({
        ...
        $(".confirm-product").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Perform AJAX request to soft delete the product
                    $.ajax({
                        url: "/admin/deleteproduct/" + productyId,
                        type: "DELETE",
                        success: function (response) {
                            Swal.fire({
                                icon: "success",
...
$(".confirm-block").on("click", function (e) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            const blocked = isChecked // If checked, it means it will be blocked

            $.ajax({
                url: "/admin/updateUserStatus/" + userId,
                type: "PUT",
                data: JSON.stringify({ blocked: blocked }), // Send the blocked status
                ...
                success: function (response) {
                    Swal.fire({
                        ...
                        // Toggle the checkbox state only if the update was successful
                        checkbox.prop("checked", !isChecked)
                        console.log("update successful");
                    })
                },
                error: function (error) {
                    console.log("Error:", error.responseText) // Log the error to the console
                    Swal.fire({
                        title: "Error",
 ...
 $(".confirm-coupon").on("click", function () {
     const productyId = $(this).data("id")
     console.log("button clicked ", productyId)
     ...
     Swal.fire({
         ...
         if (result.isConfirmed) {
             // Perform AJAX request to soft delete the product
             $.ajax({
                 url: "/admin/deletecoupon/" + productyId,
                 type: "DELETE",
                 success: function (response) {
                     Swal.fire({
                         icon: "success",
     ...
     $(".confirm-category-offer").on("click", function () {
         const productyId = $(this).data("id")
         ...
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 // Perform AJAX request to soft delete the product
                 $.ajax({
                     url: "/admin/delete-category-offer/" + productyId,
                     type: "DELETE",
                     success: function (response) {
                         Swal.fire({
                             icon: "success",
     ...
     $(".confirm-product-offer").on("click", function () {
         const productyId = $(this).data("id")
         ...
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 // Perform AJAX request to soft delete the product
                 $.ajax({
                     url: "/admin/delete-product-offer/" + productyId,
                     type: "DELETE",
                     success: function (response) {
                         Swal.fire({
                             icon: "success",
                             title: "Deleted!",
                             text: "Your product offer has been deleted.",
                             confirmButtonClass: "btn btn-success",
                         }).then(() => {
                             // Remove the deleted row from the table
                             $('a[data-id="' + productyId + '"]')
